...
Note: In dbt projects, it is common for fact and dimension table to be in core folder.
...
In this case, setting the value for `DBT_BIGQUERY_STAGING_DATASET` is not mandatory as it will default to `DBT_BIGQUERY_TARGET_DATASET`.
